...
const page = () => {
  ...
  <h2>Definitions</h2>
  <ul>
    <li><p>Non-Registered User(s):</p> Individuals who have not created an account on the website.</li>
  ...
  <p>By using this website, you acknowledge and agree to the following:</p>
  <ul>
    <li>Service may be inaccessible or inoperable due to maintenance or external factors.</li>
  ...
  <p>You are responsible for maintaining the confidentiality of your account and for all activities under your account. Inform us immediately of any unauthorized use of your account.</p>

  <h2>User Obligations</h2>
  <p>You must ensure the accuracy of information provided and use the website lawfully. You are responsible for the security of your personal information. We are not responsible for third-party websites or content linked from our website.</p>
  ...
  <h2>Waiver</h2>
  <p>Failure to act on breaches does not waive our rights to act on subsequent or similar breaches.</p>

  <h2>Right to Access</h2>
  <p>Use of the website is available only to those who can form legally binding contracts under the Indian Contract Act, 1872.</p>

  <h2>Governing Law and Jurisdiction</h2>
  <p>This Agreement is governed by the laws of India and is subject to the jurisdiction of the courts in New Delhi.</p>
